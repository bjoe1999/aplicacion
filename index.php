...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        <br>
        <!-- Aquí después del log in estamos redirigiendo al index.php de la carpeta secciones -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="password" class="form-control" name="password" id="contrasenia" aria-describedby="helpId"
